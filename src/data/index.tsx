...
const Operations = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M21.125 13.476v-2.913a8.745 8.745 0 00-.883-3.656l4.133-4.133-1.149-1.149L1.625 23.226l1.149 1.149 4.875-4.875h1.289v.813a4.063 4.063 0 008.125 0v-.813h5.687c.215 0 .422-.085.575-.238a.813.813 0 00.237-.574V16.25a.813.813 0 00-.237-.574l-2.2-2.2zm-5.688 6.837a2.438 2.438 0 01-4.875 0v-.813h4.875v.813z"
          fill="url(#unsubscribe_gradient_1)"
        />
        <path
          d="M17.558 3.85a8.753 8.753 0 00-3.745-1.372V.813h-1.626v1.665a8.753 8.753 0 00-7.31 8.085v2.913l-2.2 2.2a.813.813 0 00-.237.574v2.438c0 .08.016.16.048.235L17.558 3.85z"
          fill="url(#unsubscribe_gradient_2)"
        />
        <defs>
          <linearGradient
            id="unsubscribe_gradient_1"
            x1="2.5"
            y1="1.625"
            x2="21.688"
            y2="26.452"
