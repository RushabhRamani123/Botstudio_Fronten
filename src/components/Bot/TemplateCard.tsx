...
// Define a union type for template types
// type TemplateType = 'light' | 'dark' | 'minimalist' | 'teal' | 'rain' | 'rays' | 'aqua' | 'pi' | 'default';
...
export const TemplateCard: React.FC<TemplateCardProps> = ({ name, type, isSelected, onClick }) => {
  const getBgColor = () => {
    switch (type) {
